...
CREATE TABLE IF NOT EXISTS `proftaak2`.`users` (
  ...
  CONSTRAINT `fk_users_courses1`
    ...
    REFERENCES `proftaak2`.`courses` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `proftaak2`.`mergedfiles` (
  ...
  INDEX `fk_mergedfiles_courses1_idx` (`courses_id` ASC),
  CONSTRAINT `fk_mergedfiles_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `proftaak2`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_mergedfiles_courses1`
    FOREIGN KEY (`courses_id`)
    REFERENCES `proftaak2`.`courses` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `proftaak2`.`sourcefiles` (
  ...
  `users_id` INT NOT NULL,
  `colleges_id` INT NULL,
  `courses_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_sourcefiles_users1_idx` (`users_id` ASC),
  INDEX `fk_sourcefiles_colleges1_idx` (`colleges_id` ASC),
  INDEX `fk_sourcefiles_courses1_idx` (`courses_id` ASC),
  CONSTRAINT `fk_sourcefiles_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `proftaak2`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sourcefiles_colleges1`
    FOREIGN KEY (`colleges_id`)
    REFERENCES `proftaak2`.`colleges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sourcefiles_courses1`
    FOREIGN KEY (`courses_id`)
    REFERENCES `proftaak2`.`courses` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `proftaak2`.`versions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proftaak2`.`versions` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `version` INT NULL,
  `filedate` VARCHAR(20) NULL,
  `mergedfiles_id` INT NULL,
  `sourcefiles_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_versions_mergedfiles1_idx` (`mergedfiles_id` ASC),
  INDEX `fk_versions_sourcefiles1_idx` (`sourcefiles_id` ASC),
  CONSTRAINT `fk_versions_mergedfiles1`
    FOREIGN KEY (`mergedfiles_id`)
    REFERENCES `proftaak2`.`mergedfiles` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_versions_sourcefiles1`
...
CREATE TABLE IF NOT EXISTS `proftaak2`.`attached-files` (
  ...
  `sourcev_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_attached-files_versions1_idx` (`versions_id` ASC),
  INDEX `fk_attached-files_versions2_idx` (`sourcev_id` ASC),
  CONSTRAINT `fk_attached-files_versions1`
    FOREIGN KEY (`versions_id`)
    REFERENCES `proftaak2`.`versions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_attached-files_versions2`
    FOREIGN KEY (`sourcev_id`)
    REFERENCES `proftaak2`.`versions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
